          ...
          {!isAuthenticated ? (
            <div className="flex items-center space-x-8">
              <div className="flex space-x-6 text-sm font-medium">
                ...
                <Link to="/booking" className="text-black hover:text-gray-700">RESERVATION</Link>
              </div>
              ...
              <div className="relative">
                ...
                {isDropdownOpen && (
                  <div className="absolute right-0 mt-2 w-48 bg-white border rounded-md shadow-lg py-2">
                    ...
                    <Link to="/my-booking" className="block px-4 py-2 hover:bg-gray-100">Booking</Link>
                    <Link to="/my-room" className="block px-4 py-2 hover:bg-gray-100">รายละเอียดการเข้าพัก</Link>
                    <button
