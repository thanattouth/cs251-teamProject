...
function Navbar({ isAuthenticated, setAuth }) {
  ...
  return (
    <>
        ...
        <div className="flex items-center justify-between px-6">
          ...
          <div className="flex items-center space-x-8">
            ...
            <div className="flex space-x-6 text-sm font-medium">
              ...
              <Link to="/" className="text-black hover:text-gray-700">OUR SERVICE</Link>
              <Link to="/" className="text-black hover:text-gray-700">NEWS & ACTIVITY</Link>
      ...
      {/* ⬇️ ให้เนื้อหาแต่ละหน้ามาแสดงใต้ Navbar นี้ */}
      <div className="pt-20">
        <Outlet />
      </div>
    </>
